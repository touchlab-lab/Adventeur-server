...
adventure3 = Adventure.create! :name => 'A Perfect Game of Foosball', :description => 'desc'
...
adventure3.checkpoints.create!({:tout => "Longtime Austinites remember when the Red Eyed Fly was home to Wilco.", :description => "The Red Eyed Fly was always famous for discovering musicians before they got big. Keep an eye on whoever you see play there.", :venue_id => venues['41536380f964a5201f1d'].id, :latitude => venues['41536380f964a5201f1d'].latitude, :longitude => venues['41536380f964a5201f1d'].longitude })
...
adventure4 = Adventure.create! :name => 'My Accidental Karaoke', :description => 'desc'
...
adventure5 = Adventure.create! :name => 'It came with Coleslaw', :description => 'desc'
